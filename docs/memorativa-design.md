...
Memorativa can then be used by humans to help visualize and extend conceptual thinking, while machines can use Memorativa to better and more efficiently infer and conceptualize input.
...
For any given horoscope, planets can form angular relationships to:
