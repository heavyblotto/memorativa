...
**Sign up**
1.Player signs up for Memorativa. Options for sign up include:
  - Email with username, password, SSO option, MFA options
  - The player is given a free account.

2. The player is given clear glass beads as a sign up reward to use as game tokens.

3. The player provides profile and account information.
4. The player optionally provides the date to generate a natal horoscope and receive a set of glass beads as a reward.
5. The game begins.

**Player enters the game**

1. After successful sign up or login, the player is presented with a dashboard.
2. From the dashboard, the player can:
  - view and access Memory Houses
  - interact with the Idolum agent
  - view and manage their account settings and profile
