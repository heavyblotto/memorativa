...
```mermaid
graph TD
    subgraph "Horoscope Structure as Vector Encoding"
        percept((Percept))
        
        subgraph "Archetypal Vector (WHAT)"
            sun((Sun))
            moon((Moon))
            mercury((Mercury))
            venus((Venus))
        ...
        subgraph "Expression Vector (HOW)"
            aries[Aries]
            taurus[Taurus]
            gemini[Gemini]
            cancer[Cancer]
        ...
        %% Aspects in subgraph
        subgraph "Aspects (Angular Relationships)"
            a0[Conjunction - Unity]
            a60[Sextile - Harmony]
            a90[Square - Tension]
            a120[Trine - Flow]
            a180[Opposition - Polarity]
        end
    end
    
    classDef percept fill:#ffcc80,stroke:#e65100,color:#000
    classDef planet fill:#f8bbd0,stroke:#c2185b,color:#000
    classDef sign fill:#c8e6c9,stroke:#2e7d32,color:#000
    classDef house fill:#bbdefb,stroke:#1565c0,color:#000
    classDef aspect fill:#d1c4e9,stroke:#4527a0,color:#000
    
    class percept percept
    class sun,moon,mercury,venus,mars,jupiter planet
    class aries,taurus,gemini,cancer,leo,virgo sign
    class h1,h2,h3,h4,h5,h6 house
    class a0,a60,a90,a120,a180 aspect
```
*Figure 4: Horoscope structure as vector encoding system, showing planets (WHAT/Archetypal Vector), signs (HOW/Expression Vector), and houses (WHERE/Mundane Vector), along with their relationships and aspects that create semantic connections between concepts*
